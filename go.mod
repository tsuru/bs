...
require (
	github.com/Graylog2/go-gelf v0.0.0-00010101000000-000000000000
	...
	github.com/docker/docker v1.4.2-0.20180924202107-a9c061deec0f // indirect
...
replace (
	github.com/Graylog2/go-gelf => github.com/cezarsa/go-gelf v0.0.0-20181026022425-1ff80b6cbc53
