	...
	expected := []format.LogParts{
		{
			...
			"facility":     3,
			"severity":     3,
			"timestamp":    time.Date(time.Now().Year(), 7, 21, 18, 26, 01, 0, time.Local),
			"hostname":     "",
		...
		},
		{
			...
			"facility":     3,
			"severity":     6,
			"timestamp":    time.Date(time.Now().Year(), 5, 13, 21, 10, 17, 0, time.Local),
			"hostname":     "",
		...
		},
		{
			...
			"facility":     3,
			"severity":     7,
			"timestamp":    time.Date(time.Now().Year(), 12, 26, 5, 8, 46, 0, time.Local),
			"hostname":     "hostname",
			"tag":          "tag/my_id",
			"content":      "",
			"container_id": "my_id",
